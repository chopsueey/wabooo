  ...
  return (
    <div className="mx-auto lg:max-w-5xl xl:max-w-screen-2xl sm:px-6 lg:px-8">
      <section className="bg-gray-500 bg-opacity-25 rounded-xl row flex flex-col min-h-screen justify-center lg:flex-row sm:px-6 lg:px-8 xl:px-20 relative shadow-lg shadow-gray-950">
        <section className="flex flex-col justify-center items-center p-2 mt-10 sm:mt-16">
          <h2 className="text-white  text-center text-5xl lg:text-7xl mb-10 font-bold ">
            Hey 👋, nice to see you here!
          </h2>
          <h2 className="blubb rounded-xl shadow-lg shadow-black text-white text-xl mb-10 font-light sm:mt-20 p-4 sm:p-10 sm:px-20 w-fit sm:mx-10 max-w-[800px]">
            <span className="text-cyan-400">Wabooo</span> is a webdevelopment project made by four students from
            Germany. This project was developed as a final project at the DCI
            (Digital Career Institute). We used React, Node.js, MongoDB and
            Express.js (and Vite as bundler and dev-environment), to build a
            social-media webapp.
            <br />
            <br />
            If you signup (or just click on 'Test account'), you will see several
            ...
            coming from (supposing their profil is legit).
            <br/>
            <br/>
            <Link className="text-cyan-400 hover:underline" to="/contact">Connect with us!</Link> 
          </h2>
        </section>
      </section>
    </div>
